...
"""
# 1 - Récupérer la liste des URLs de catégories
2 - Ouvrir chaque catégorie
3 - Checker si la catégorie a plusieurs pages
4 - Générer la ou les URLs à scraper
5 - Scraper chaque URL
"""

"""
categories_url : [toutes les URLs de categories]
pages_to_scrap : [soup de toutes les pages]
"""

# def open_categories ():
#     for categories in categories_url:
#         good_url = "http://books.toscrape.com/catalogue/" + categories
#         connect = requests.get(good_url)
#         category_url_content = connect.content
#         soupes = BeautifulSoup(category_url_content, "html.parser")
#         print(soupes)
